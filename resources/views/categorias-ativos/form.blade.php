...
@section('title', isset($categoria) ? 'Editar categoria de ativo' : 'Cadastrar categoria de ativo')
...
<div class="usuarios-container">
    ...
    <div class="usuarios-header">
        <h2>{{ isset($categoria) ? 'Editar categoria de ativo' : 'Cadastrar categoria de ativo' }}</h2>
    </div>
    ...
    <div class="form-wrapper mt-4">
        <form action="{{ isset($categoria) ? route('categorias-ativos.update', $categoria->nr_sequencia) : route('categorias-ativos.store') }}"
            ...
            <div class="form-section">
                <div class="form-row">
                    <div class="form-group half">
                        <label for="nr_sequencia">
                            Sequência
                            <i class="fa-solid fa-circle-info info-icon" title="Tabela: categorias_ativo | Atributo: nr_sequencia"></i>
                        </label>
                        <input type="text"
                            id="nr_sequencia"
                            name="nr_sequencia"
                    ...
                    <div class="form-group half">
                        <label for="ds_nome">
                            Nome
                            <i class="fa-solid fa-circle-info info-icon" title="Tabela: categorias_ativo | Atributo: ds_nome"></i>
                        </label>
                        <input type="text"
                            id="ds_nome"
                            name="ds_nome"
                ...
                <div class="form-group">
                    <label for="ds_observacao">
                        Observação
                        <i class="fa-solid fa-circle-info info-icon" title="Tabela: categorias_ativo | Atributo: ds_observacao"></i>
                    </label>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group half">
                        <label for="ie_status">
                            Status
                            <i class="fa-solid fa-circle-info info-icon" title="Tabela: categorias_ativo | Atributo: ie_status"></i>
                        </label>
                        <select id="ie_status"
                                name="ie_status"
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('categorias-ativos.index') }}" class="btn btn-secondary">Cancelar</a>
