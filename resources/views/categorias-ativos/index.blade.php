...
@section('title', 'Categoria de Ativos')
...
<div class="usuarios-container">
    <div class="usuarios-header">
        <h2>Categorias de Ativo</h2>

        <div class="usuarios-actions">
            <form action="{{ route('categorias-ativos.index') }}" method="GET" class="usuarios-search">
            ...
            <a href="{{ route('categorias-ativos.create') }}" class="btn btn-success">Adicionar</a>
        </div>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="usuarios-acoes">
                            <a href="{{ route('categorias-ativos.edit', $categoria->nr_sequencia) }}" class="btn btn-sm btn-primary"><i class="fa-solid fa-square-pen"></i></a>
                            <form action="{{ route('categorias-ativos.destroy', $categoria->nr_sequencia) }}" method="POST" class="d-inline"
    ...
    @else
        <div class="alert alert-info text-center mt-4">Nenhuma categoria de ativo encontrada.</div>
    @endif
</div>
@endsection
